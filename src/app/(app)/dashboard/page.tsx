      ...
      <div className="page-header">
        <div>
          ...
          <p style={{ fontSize: '0.78rem', color: 'var(--gray-600)', marginTop: 6 }}>
            DepEd beneficiaries come from SBFP SDO procurement (column K). Total Records and DepEd milk packs use the MFP masterlist; other funders use the masterlist.
          </p>
        </div>
        {centerFilter && (
