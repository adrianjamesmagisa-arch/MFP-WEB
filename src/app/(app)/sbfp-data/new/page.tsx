...
export default function NewSbfpDataPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto py-8">
      <div className="mb-6 flex items-center gap-4">
        <Link href="/sbfp-data" className="p-2 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-full transition-colors">
          <ArrowLeft className="h-5 w-5" />
        </Link>
        <div>
          <h1 className="text-2xl font-bold tracking-tight">Add SBFP Record</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              ...
              <select name="center" required className="w-full p-2 border rounded bg-background">
          ...
          <div className="pt-4 flex justify-end gap-4 border-t">
            <Link href="/sbfp-data" className="px-4 py-2 border rounded hover:bg-muted font-medium">
              Cancel
            </Link>
            <button 
              type="submit" 
